...
co11 <- coeftest(fe1 , vcov = vcovHAC(fe1, type="HC1"))[1:5,1]
col1 <- c(col1, dim(drop_na(a_b))[1])
fe2 = felm(formula = urbrate ~ fpresence1750 + fpresence1800 + 
           fpresence1850 + fpresence1875 + fpresence1900 + 
           yr1700 + yr1750 + yr1800 + yr1850 + 
       yr1875 | id, 
     data = a_b )
co12 <- coeftest(fe2, vcov = vcovHAC(fe2, type="HC1"))[1:5,1]
col2 <- c(col2, dim(drop_na(a_b))[1])
```
...
col3 <- coeftest(fe3 , vcov = vcovHC(fe3, type="HC0"))[1:5, 1]
col3 <- c(col3, dim(drop_na(keep))[1])
...
fe4 = felm(formula = urbrate ~ fpresence1750 + fpresence1800 + 
       ...
       yr1875 | id, 
     data = keep )
col4 <- coeftest(fe4, vcov = vcovHC(fe4, type="HC0"))[1:5, 1]
col4 <- c(col4, dim(drop_na(keep))[1])
